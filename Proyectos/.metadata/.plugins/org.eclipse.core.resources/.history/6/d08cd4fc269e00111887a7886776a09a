...
#define RS485_START_BYTE    0x3AU   /* ':'  */
#define RS485_END_BYTE      0x0DU   /* '\r' */

/* =========================================================
 * ÚLTIMO PAQUETE RECIBIDO
 * =========================================================
 *
 * La librería solo publica paquetes dirigidos al ID local o
 * a ID_BROADCAST. El main debe copiar los datos y después
 * poner rs485_paquete_listo en 0.
 */

extern volatile uint8_t rs485_paquete_listo;
